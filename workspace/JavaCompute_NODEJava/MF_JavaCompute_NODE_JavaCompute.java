...
public class MF_JavaCompute_NODE_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			MbElement JsonData = outputroot.createElementAsFirstChild(MbJSON.OBJECT,MbJSON.DATA_ELEMENT_NAME, null).createElementAsLastChild(MbElement.TYPE_NAME,"Student",null);
			
			//MbElement resp = JsonData.createElementAsLastChild(MbElement.TYPE_NAME,"Student",null);
