...
public class MF_Globel_cache_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		//	String Message = EmpObject.getFirstElementByPath("Message").getValueAsString();
			...
			MbElement OutpuRoot = outMessage.getRootElement().createElementAsLastChild(MbXMLNSC.PARSER_NAME);
			MbElement ResponseObject = OutpuRoot.createElementAsLastChild(MbXMLNSC.FOLDER,"Response","");
			ResponseObject.createElementAsFirstChild(MbXMLNSC.FOLDER,"Message","Data loaded Successfully");
